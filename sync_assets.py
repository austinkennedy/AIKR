...
mapping = {
    ...
    os.path.join(EXPANDED_TRIMMED_PATH, 'volumes_over_time/corpus_vs_transl_categories.png'): 'fig_b_3',
    os.path.join(EXPANDED_TRIMMED_PATH, 'topic_triangles/color') : 'fig_b_4',
    os.path.join(EXPANDED_TRIMMED_PATH, 'famous_volumes.png'): 'fig_b_5',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volumes_over_time/avg_progress.png'): 'fig_b_6',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volume_triangles/progress_original'): 'fig_b_7',
    os.path.join(EXPANDED_TRIMMED_PATH, 'regression_figures/progress_original_percentile/predicted_values.png'): 'fig_b_8',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volume_triangles/progress_secondary'): 'fig_b_9',
    os.path.join(EXPANDED_TRIMMED_PATH, 'regression_figures/progress_secondary_percentile/predicted_values.png'): 'fig_b_10',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volume_triangles/progress_regression_main'): 'fig_b_11',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volumes_over_time/avg_progress_translations_raw.png'): 'fig_b_13',
    os.path.join(EXPANDED_TRIMMED_PATH, 'volume_triangles/progress_main/color'): 'fig_b_14',
    os.path.join(EXPANDED_TRIMMED_PATH, 'subtriangles'): 'fig_b_15',
    os.path.join(EXPANDED_TRIMMED_PATH, 'drop_1650/regression_figures/progress_main_percentile/predicted_values.png'): 'fig_b_16',
